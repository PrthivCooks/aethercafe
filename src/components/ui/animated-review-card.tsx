...
const cardVariants = cva(
  "absolute h-[300px] w-[300px] overflow-hidden rounded-lg sm:w-[350px] md:h-[250px] md:w-[550px]",
  {
    variants: {
      theme: {
        default: "border border-border bg-background",
        primary: "bg-primary-50 border border-primary/20",
        elegant: "border border-zinc-200 bg-zinc-50 text-zinc-900 dark:border-white/10 dark:bg-[#1E1A17] dark:text-zinc-100",
        vibrant: "border border-fuchsia-400 bg-gradient-to-br from-fuchsia-500 to-pink-500 text-white",
        minimal: "border border-gray-100 bg-gray-50 text-gray-900",
      },
      cursor: {
...
const starColorVariants = {
  ...
  elegant: {
    active: "text-[#D4AF37] fill-current",
    inactive: "text-white/10",
  },
  vibrant: {
  ...
  minimal: {
    active: "text-gray-900 fill-current",
